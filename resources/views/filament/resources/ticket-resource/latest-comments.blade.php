<div class="space-y-4">
                        ...
                        <div class="flex-1 min-w-0">
                            <div class="flex flex-col sm:flex-row sm:justify-between sm:items-center">
                                <div class="text-sm font-medium text-gray-900 dark:text-gray-100">
                                    {{ $comment->user->name ?? __('resources.ticket.comments.unknown_user') }}
                                </div>
                                    ...
                                    @if(auth()->user()->hasRole(['super_admin']) || $comment->user_id === auth()->id())
                                        <div class="flex gap-x-1">
                                            ...
                                            <a
                                                ...
                                                title="{{ __('resources.ticket.comments.actions.edit') }}"
                                            >
                                            ...
                                            <button
                                                ...
                                                title="{{ __('resources.ticket.comments.actions.delete') }}"
                                            >
                                                <svg xmlns="http://www.w3.org/2000/svg" class="h-4 w-4" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                                            ...
                                            <x-filament::modal
                                                ...
                                                icon-color="danger"
                                                heading="{{ __('resources.ticket.comments.modal.title') }}"
                                                width="md"
                                            >
                                                <div class="py-4">
                                                    {{ __('resources.ticket.comments.modal.message') }}
                                                </div>
                                                ...
                                                <x-slot name="footerActions">
                                                    <x-filament::button
                                                        ...
                                                        color="gray"
                                                    >
                                                        {{ __('resources.ticket.comments.modal.cancel') }}
                                                    </x-filament::button>
                                                    ...
                                                    <x-filament::button
                                                        ...
                                                        color="danger"
                                                    >
                                                        {{ __('resources.ticket.comments.modal.confirm') }}
                                                    </x-filament::button>
                                                </x-slot>
                                            </x-filament::modal>
                                        </div>
    ...
    @else
        <div class="flex items-center justify-center py-6 text-gray-500 dark:text-gray-400 bg-gray-50 dark:bg-gray-800 rounded-lg border border-gray-200 dark:border-gray-700">
            ...
            <span class="text-sm font-medium">{{ __('resources.ticket.comments.empty') }}</span>
        </div>
    @endif
</div>
