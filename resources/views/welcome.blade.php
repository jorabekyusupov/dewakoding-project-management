...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    <head>
        ...
        <title>{{ config('app.name', __('welcome.app_name')) }}</title>
        ...
        <div class="min-h-screen flex flex-col items-center">
            <header class="w-full py-6 px-6 sm:px-10 flex justify-between items-center">
                <div class="flex items-center space-x-2">
                    ...
                    <span class="text-xl font-semibold">{{ __('welcome.brand') }}</span>
                </div>
                ...
                <div class="max-w-4xl w-full">
                    <div class="text-center mb-12">
                        <h1 class="text-4xl md:text-5xl font-bold mb-4">
                            {{ __('welcome.hero.title_main') }}
                            <span class="text-gradient">{{ __('welcome.hero.title_highlight') }}</span>
                        </h1>
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-3 gap-8 mb-16">
                        <div class="bg-white p-6 rounded-lg shadow-md border border-gray-100">
                            <div class="flex items-center mb-4">
                                ...
                                <h2 class="text-lg font-semibold">{{ __('welcome.features.task_management.title') }}</h2>
                            </div>
                            <p class="text-gray-600">
                                {{ __('welcome.features.task_management.description') }}
                            </p>
                        </div>
                        ...
                        <div class="bg-white p-6 rounded-lg shadow-md border border-gray-100">
                            <div class="flex items-center mb-4">
                                ...
                                <h2 class="text-lg font-semibold">{{ __('welcome.features.team_collaboration.title') }}</h2>
                            </div>
                            <p class="text-gray-600">
                                {{ __('welcome.features.team_collaboration.description') }}
                            </p>
                        </div>
                        ...
                        <div class="bg-white p-6 rounded-lg shadow-md border border-gray-100">
                            <div class="flex items-center mb-4">
                                ...
                                <h2 class="text-lg font-semibold">{{ __('welcome.features.progress_tracking.title') }}</h2>
                            </div>
                            <p class="text-gray-600">
                                {{ __('welcome.features.progress_tracking.description') }}
                            </p>
                        </div>
                    </div>
            ...
            <footer class="w-full py-8 px-6 sm:px-10">
                <div class="max-w-4xl mx-auto text-center">
                    <p class="text-gray-600">&copy; {{ date('Y') }} {{ __('welcome.brand') }}. {{ __('welcome.footer.rights') }}</p>
                    <p class="text-sm text-gray-500 mt-2">{{ __('welcome.footer.credit') }}</p>
                </div>
            </footer>
        </div>
    </body>
